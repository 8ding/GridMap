...
public static class MeshUtils {
    ...
    public static void AddToMeshArrays(Vector3[] vertices, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float baseSize) {
		//Relocate vertices
		int vIndex = index*4;
		int vIndex0 = vIndex;
		int vIndex1 = vIndex+1;
		...
		vertices[vIndex1] = pos+new Vector3(0, baseSize);
		vertices[vIndex2] = pos+new Vector3( baseSize, baseSize);
		vertices[vIndex3] = pos+new Vector3(baseSize, 0);;
